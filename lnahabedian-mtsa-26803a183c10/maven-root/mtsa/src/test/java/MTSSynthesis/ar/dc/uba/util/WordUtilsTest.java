...
public class WordUtilsTest {
	...
	public void testSuffixes() {
		...
		Collections.addAll(desiredResult, this.parseWord(""), this.parseWord("c"), this.parseWord("turnOff|c"), this
		...
		assertEquals("the original was modified!",originalWord, this.parseWord(wordStr));
	}
	...
	public void testPreffixes() {
		...
		// The desired result
		Set<Word> desiredResult = new HashSet<Word>();
		Collections.addAll(desiredResult, this.parseWord(""), this.parseWord("goUp"), this.parseWord("goUp|move"), this
