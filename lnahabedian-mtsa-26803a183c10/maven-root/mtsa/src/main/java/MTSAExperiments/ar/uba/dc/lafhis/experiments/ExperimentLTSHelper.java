...
public class ExperimentLTSHelper {

	private static ExperimentLTSHelper instance;

	public static ExperimentLTSHelper getInstance() {
		if (instance == null)
			instance = new ExperimentLTSHelper();
		return instance;
	}

	public CompositeState getCompositeFromFile(String ltsFilename,
	...
	public LTS<Long, String> getLTSFromFile(String ltsFilename,
			String modelName) {
		// parse input file
		File ltsFile = new File(ltsFilename);
		try {
	...
	public Set<LTS<Long, String>> getSafetyProcessesFromFile(
	...
	public Set<String> getControllableActionsFromFile(String ltsFilename,
			String controllerName) {
		// parse input file
		File ltsFile = new File(ltsFilename);
		try {
	...
	public GRGoal<Long> getGRGoalFromFile(String ltsFilename,
			String controllerName) {
		// parse input file
		File ltsFile = new File(ltsFilename);
		try {
	...
	public GRControllerGoal<String> getGRControllerGoalFromFile(
