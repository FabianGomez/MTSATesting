...
*/
    ...
    */
    ...
    public String[] getPureAlphabet() {
        Alphabet currentAlphabet = new Alphabet(this);
        Set<String> set = currentAlphabet.root.toSet();
        String[] result = new String[set.size()];
        Iterator iterate = set.iterator();
        for (int i = 0; i < currentAlphabet.root.toSet().size(); i++) {
            result[i] = (String) iterate.next();
        }
        return result;
    }
