...
public class HPWindow extends JFrame implements Runnable {
    ...
    private void MTSMenu(JMenuBar mb) {
        mts = new JMenu("MTS");
        mb.add(mts);
    ...
    private void buildMenu(JMenuBar mb) {
        ...
        build_compose.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_W, ActionEvent.CTRL_MASK));
...
//        executer.setPriority(Thread.NORM_PRIORITY - 1);
    ...
    private void checkDeterministic() {
        ...
        if (current == null) {
            ltsOutput.outln("*** Compile an LTS before checking determinism");

        } else {
            CompactState currentCS = current.getComposition();
            if (currentCS.isNonDeterministic()) {
                ltsOutput.outln("This is a non deterministic LTS");
            } else {
                ltsOutput.outln("This is a deterministic LTS");
            }
        }
    }
    ...
    class ExampleFileAction implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            String selection = "";
            SwingUtilities.invokeLater(new FileBrowser(examplesDir, selection));
        }
    }
                ...
                boolean areRefinement = TransitionSystemDispatcher
                        .isRefinement(selectMachine(refinementOptions
                                ...
                                selectMachine(refinementOptions
                                        ...
                                        .getRefinementSemantic(), ltsOutput);
