...
public class RefinementWindow extends JDialog { //JFrame {
    ...
    private void initComponents(String[] models, SemanticType[] refinemetTypes, Mode mode) {
...
//                .add(jLlabelModelsToCheck)
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .add(jPanel1Layout.createSequentialGroup()
                .add(15, 15, 15)
                .add(labelRefinementSemantic, GroupLayout.PREFERRED_SIZE, 60, GroupLayout.PREFERRED_SIZE)
