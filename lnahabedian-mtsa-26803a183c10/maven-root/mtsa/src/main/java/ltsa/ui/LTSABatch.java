...
import java.io.*;
import java.util.*;
//TODO: refactor to leave only batch responsabilities
public class LTSABatch
        implements LTSManager, LTSInput, LTSOutput, LTSError {

    /**
     * Get MTSA Settings singleton class. Share variables across MTSA using this setting file.
     */
    MTSASettings mtsaSettings = MTSASettings.getInstance();
...
//								      memo, ref, heur,proj,modulesCount);	
    ...
    private static void showUsage() {
        String usage = "LTSABatch usage:\n\t" +
                ...
                "\t--threadCount | -t <NUMBER_OF_THREADS> : Specify number of Threads to calculate game rank, default 1.\n" +
    ...
    public static void main(String[] args) {
        ...
        Option threadCount = cmdParser.addIntegerOption('t', "threadCount");
        ...
        Integer threadCountValue = (Integer) cmdParser.getOptionValue(threadCount);
        ...
        if (threadCountValue != null) {
            MTSASettings.getInstance().threadCountGameSolver = threadCountValue;
        }
