...
public class WordUtils {
	...
	public Set<Word> preffixes(Word word) {
		//First reverse the word, then get the suffixes. The reverses of the suffixes are
		// the preffixes of the original word (trust me!...or see the test case)
		return this.getReverses(this.suffixes(word.getReverseWord()));
	}
