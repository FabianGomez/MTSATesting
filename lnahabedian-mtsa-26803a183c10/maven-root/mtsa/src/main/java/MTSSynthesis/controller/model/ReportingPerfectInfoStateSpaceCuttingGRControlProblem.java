...
import MTSSynthesis.controller.game.gr.perfect.StateSpaceCuttingPerfectInfoOppositeGrControlProblem;
import MTSSynthesis.controller.game.model.SafeGameSolver;
...
public class ReportingPerfectInfoStateSpaceCuttingGRControlProblem
    ...
    public class CompositeReport {
        ...
        public CompositeReport(String testName, GRControllerGoal<String> goal,
    ...
    public ReportingPerfectInfoStateSpaceCuttingGRControlProblem(
            ...
            GRControllerGoal<String> grControllerGoal, String outputFileName,
        ...
        super(originalEnvironment, grControllerGoal, trapState, runNoG, runAssumptions, true, relaxAllControllables, relaxOnAssumptions, relaxSelfLoops);
    ...
    protected LTS<Long, String> primitiveSolve() {
        ...
        System.gc();
        GRGame<Long> game = new GRGameBuilder<Long, String>().buildGRGameFrom(new MTSAdapter<Long, String>(envForController), grControllerGoal);
